                        ...
                        <div class="header-left">
                            <div class="dashboard_bar">
                                ...
                                if ($current_page === 'index.php') {
                                    $pageTitle = 'Dashboard';
                                } elseif ($current_page === 'data_jurusan.php') {
                                    $pageTitle = 'Data Jurusan';
                                } elseif ($current_page === 'data_mahasiswa.php') {
                                    $pageTitle = 'Data Mahasiswa';
                                } elseif ($current_page === 'data_operator.php') {
                                    $pageTitle = 'Operator Sistem';
                                } else {
                                    $pageTitle = 'Dashboard';
                                }
                                ?>
        ...
        <div class="deznav">
            <div class="deznav-scroll mm-active">
                <ul class="metismenu mm-show" id="menu">
                    <li class=""><a href="index.php" class="ai-icon mm-active" aria-expanded="false">
                            <i class="flaticon-381-networking"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                    <li><a href="data_jurusan.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-notepad"></i>
                            <span class="nav-text" id>Data Jurusan</span>
                        </a>
                    </li>
                    <li><a href="data_mahasiswa.php" class="ai-icon" aria-expanded="false">
