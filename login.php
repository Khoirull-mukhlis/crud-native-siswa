                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    if (isset($_GET['err'])) {
                                        ...
                                        if ($error == 'true') {
                                            echo '<div class="alert alert-warning alert-dismissible alert-alt fade show">
                                    ...
                                    if (isset($_POST['login'])) {
                                        ...
                                        $cek = mysqli_query($conn, "SELECT email_operator, password_operator FROM operator_sistem WHERE email_operator= '$email' AND password_operator = '$password'");


                                        if (mysqli_num_rows($cek) > 0) {

                                            $operator = mysqli_query($conn, "SELECT * from operator_sistem where email_operator = '$email'");
                                            ...
                                            // Mengatur waktu login
                                            date_default_timezone_set('Asia/Jakarta');
                                            $waktu_login = date('Y-m-d H:i:s');

                                            mysqli_query($conn, "UPDATE operator_sistem SET last_login='$waktu_login' WHERE id_operator='$row[id_operator]'");
