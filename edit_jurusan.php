...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="data_jurusan.php">Data Mahasiswa</a></li>
...
if (isset($_POST['edit'])) {
    ...
    $simpan = mysqli_query($conn, "UPDATE data_jurusan
    SET nama_jurusan = '$nama_jurusan'
    where id_jurusan = '$id'");

    if ($simpan) {
        $query = "SELECT * FROM data_jurusan WHERE id_jurusan = '$id'";
